# /home/nicolas/Escritorio/proyecto ETL/develop/src/extract/airbnb_extract.py
...
RELATIVE_CSV_PATH_AIRBNB = "data/raw/Airbnb_Open_Data.csv" # Asegúrate que este sea el nombre y ruta correctos

def get_project_root() -> str:
    """
    Encuentra la ruta raíz del proyecto asumiendo que este script está en
    PROJECT_ROOT/src/extract/airbnb_extract.py.
    """
    return os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))

def extract_airbnb_main_data(csv_path: str = None, encoding: str = 'ISO-8859-1', low_memory: bool = False) -> pd.DataFrame:
    """
    ...
    try:
        ...
        # Usamos los parámetros de encoding y low_memory como en tu código original de extract_data.py
...
if __name__ == '__main__':
    ...
    try:
        ...
        airbnb_df_default = extract_airbnb_main_data()
